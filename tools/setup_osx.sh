...
# sudo scutil --set ComputerName "graveyard"
# sudo scutil --set HostName "graveyard"
# sudo scutil --set LocalHostName "graveyard"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "graveyard"
